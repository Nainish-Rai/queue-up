  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">{waitlistData.name}</h1>
          <p className="text-muted-foreground">/{waitlistData.slug}</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{waitlistData.signupCount}</div>
          </CardContent>
        </Card>
